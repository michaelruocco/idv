...
import uk.co.idv.api.lockout.LockoutStateDocument;
import uk.co.idv.api.lockout.ResetLockoutStateDocument;
...
class LockoutControllerTest {
    ...
    private final LockoutState state = new FakeHardLockoutState();
