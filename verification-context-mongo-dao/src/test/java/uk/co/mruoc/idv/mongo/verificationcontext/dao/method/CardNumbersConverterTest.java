...
class CardNumbersConverterTest {
    ...
    private final CardNumberConverter cardNumberConverter = mock(CardNumberConverter.class);

    private final CardNumbersConverter cardNumbersConverter = new CardNumbersConverter(cardNumberConverter);
